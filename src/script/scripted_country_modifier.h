...
public:
	...
	static constexpr const char property_class_identifier[] = "kobold::scripted_country_modifier*";
	...
	Q_INVOKABLE QString get_modifier_string(kobold::country *scope) const
	{
