...
public:
	...
	static constexpr const char property_class_identifier[] = "kobold::scripted_character_modifier*";
	...
	Q_INVOKABLE QString get_modifier_string(kobold::character *scope) const
	{
