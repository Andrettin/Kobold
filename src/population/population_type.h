...
class population_type final : public named_data_entry, public data_type<population_type>
{
	...
	Q_PROPERTY(kobold::population_class* population_class MEMBER population_class NOTIFY changed)
	...
	Q_PROPERTY(kobold::icon* small_icon MEMBER small_icon NOTIFY changed)
...
public:
	...
	static constexpr const char property_class_identifier[] = "kobold::population_type*";
...
public:
	...
	const kobold::icon *get_small_icon() const
	{
		return this->small_icon;
	}

	const kobold::icon *get_phenotype_icon(const phenotype *phenotype) const
	{
	...
	const kobold::icon *get_phenotype_small_icon(const phenotype *phenotype) const
	{
	...
	Q_INVOKABLE QString get_country_modifier_string(const kobold::country *country) const;
...
private:
	...
	kobold::icon *small_icon = nullptr;
	phenotype_map<const kobold::icon *> phenotype_icons;
	phenotype_map<const kobold::icon *> phenotype_small_icons;
