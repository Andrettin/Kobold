...
transporter::transporter(const transporter_type *type, const kobold::country *country, const kobold::culture *culture, const kobold::religion *religion, const kobold::phenotype *phenotype, const kobold::site *home_settlement)
	: type(type), country(country), culture(culture), religion(religion), phenotype(phenotype), home_settlement(home_settlement)
{
