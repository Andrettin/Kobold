...
class taxon final : public taxon_base, public data_type<taxon>
{
	...
	Q_PROPERTY(QString common_name READ get_common_name_qstring NOTIFY changed)
	Q_PROPERTY(kobold::taxonomic_rank rank MEMBER rank READ get_rank NOTIFY changed)

public:
	static constexpr const char class_identifier[] = "taxon";
	static constexpr const char property_class_identifier[] = "kobold::taxon*";
