...
const name_generator *taxon_base::get_personal_name_generator(const gender gender) const
{
...
void taxon_base::add_personal_name(const gender gender, const name_variant &name)
{
	if (this->personal_name_generator == nullptr) {
		this->personal_name_generator = std::make_unique<gendered_name_generator>();
	}
...
void taxon_base::add_personal_names_from(const taxon_base *other)
{
