	...
	Column {
		...
		Repeater {
			...
			TextButton {
				...
				tooltip: format_text(small_text(advisor.game_data.get_advisor_effects_string(kobold.game.player_country)))
				
				readonly property var advisor: model.modelData
				
				onClicked: {
					kobold.game.player_country.game_data.next_advisor = advisor
