...
DialogBase {
	...
	readonly property string portrait_identifier: portrait_object !== null ? (portrait_object.class_name === "kobold::character" ? portrait_object.game_data.portrait.identifier : portrait_object.identifier) : ""
	...
	Column {
		...
		PortraitButton {
			...
			readonly property bool is_character: portrait_object !== null && portrait_object.class_name === "kobold::character"
		}
