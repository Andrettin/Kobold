...
Item {
	...
	CustomIconImage {
		...
		readonly property string modifier_string: country_game_data.government_type.modifier_string
	}
	...
	CustomIconImage {
		...
		readonly property var country_tier_data: kobold.get_country_tier_data(country_game_data.tier)
