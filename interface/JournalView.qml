...
Item {
	...
	readonly property var country: kobold.game.player_country
	...
	ListView {
		...
		delegate: Item {
			...
			readonly property string completion_effects_string: journal_entry.get_completion_effects_string(kobold.game.player_country)
			readonly property string failure_conditions_string: journal_entry.get_failure_conditions_string()
			readonly property string failure_effects_string: journal_entry.get_failure_effects_string(kobold.game.player_country)
