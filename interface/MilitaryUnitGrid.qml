...
Grid {
	...
	Repeater {
		...
		Item {
			...
			readonly property int country_military_unit_count: selected_province.game_data.get_country_military_unit_category_count(military_unit_category, kobold.game.player_country)
			...
			Image {
				...
				MouseArea {
					...
					onReleased: {
						kobold.change_selected_military_unit_category_count(military_unit_category, 1, selected_province)
						military_unit_selected_count_label.text = number_string(kobold.get_selected_military_unit_category_count(military_unit_category))
					}
				}
			}
			...
			SmallText {
				...
				text: number_string(kobold.get_selected_military_unit_category_count(military_unit_category))
				anchors.right: parent.right
				anchors.rightMargin: 4 * scale_factor
