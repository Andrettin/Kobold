...
Rectangle {
	...
	IndustryCounter {
		...
		name: kobold.defines.research_commodity.name
		icon_identifier: kobold.defines.research_commodity.icon.identifier
		count: country_game_data.get_stored_commodity(kobold.defines.research_commodity)
